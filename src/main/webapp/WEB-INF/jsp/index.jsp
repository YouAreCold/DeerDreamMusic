...
<head>
    ...
    <!-- 不支持IE8及以下版本浏览器 -->
    <!--[if lte IE 8]>
        <script>window.location.href="${path }/DeerDreamMusic-View/plugns/killie/"</script>
    <![endif]-->
    ...
    <!-- layer弹窗插件样式文件 -->
    <link rel="stylesheet" href="${path }/DeerDreamMusic-View/plugns/layer/skin/default/layer-def.css">
    
    <!--美化 单选框与复选框等-->
    <link rel="stylesheet" type="text/css" href="${path }/DeerDreamMusic-View/plugns/radioandcheck/magic-check.css">
</head>
<body>
...
<div class="center">
    <div class="container">
        ...
        <div class="player" id="player">
            <!--歌曲封面-->
            <div class="cover">
                <img src="${path }/DeerDreamMusic-View/images/player_cover.png" class="music-cover" id="music-cover">
            </div>
            <!--滚动歌词-->
            <div class="lyric">
                <ul id="lyric"></ul>
